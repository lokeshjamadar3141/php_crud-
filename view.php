...
<body>
	<div class="form2">
	<p style="margin-left: 130px;"> <a href="index.php">Home</a> | <a href="insert.php">Insert New Record</a> | <a href="logout.php">Logout</a></p>
	<h2 style="margin-left: 160px;">View Records</h2>
